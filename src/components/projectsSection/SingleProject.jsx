...
const SingleProject = ({ name, year, align, image, link }) => {
  return (
    <motion.div
      ...
      className={`flex w-ful sm:flex-col-reverse items-center gap-8 ${
        align === "left" ? "md:flex-row" : "md:flex-row-reverse"
      } justify-end`}
    >
      <div>
        <h2 className="md:text-3xl sm:text-2xl text-color2">{name}</h2>
        <h2
        ...
        <a
          ...
          className={`text-lg flex gap-2 items-center text-lightGrey hover:text-orange transition-all duration-500 cursor-pointer sm:justify-self-center ${
